...
Interfaz Linux solo en inglés. Otras distribuciones y arquitecturas sin verificar. Reproducción finita, sin bucle continuo garantizado. No incluye cámara, capturadora ni gráfica integrada; un mensaje heredado del motor puede mencionar una gráfica que esta interfaz no muestra. Las tablas horarias son una instantánea del momento de preparación. Archivos de trabajo en `~/.local/share/one-seg-studio`.
